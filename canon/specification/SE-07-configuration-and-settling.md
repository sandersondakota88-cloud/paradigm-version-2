...
1. The solver is external to the problem; it converts.
1. The solution terminates the process.
...
1. The substrate is not external to its configuration. The
...
1. The settling does not terminate. Per F4 (operates indefinitely)
