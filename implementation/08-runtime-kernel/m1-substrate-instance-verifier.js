...
async function main() {
  ...
  test("Mutating A's field does NOT affect B's field", () => {
    ...
    a.field.constraints.push({
      id: "test", kind: "data", pattern: { type: "test" },
  ...
  test("Three instances side-by-side: independent constraint arrays", () => {
    ...
    a.field.constraints.push({ id: "a1", kind: "data", birth: 0, lastUsed: 0, uses: 0, weight: 1, permanent: false });
    a.field.constraints.push({ id: "a2", kind: "data", birth: 0, lastUsed: 0, uses: 0, weight: 1, permanent: false });
    b.field.constraints.push({ id: "b1", kind: "data", birth: 0, lastUsed: 0, uses: 0, weight: 1, permanent: false });
    // C unchanged
  ...
  test("observe() reports per-instance state", () => {
    ...
    a.field.step = 5;
    a.field.constraints.push({ id: "x", kind: "data", birth: 0, lastUsed: 0, uses: 0, weight: 1, permanent: false });
    const o = a.observe();
    assert(o.id === "obs-A");
    assert(o.step === 5);
