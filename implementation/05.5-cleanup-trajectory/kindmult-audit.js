...
function emitCrossStreamSummary(baseA, kfA, afA, baseB, kfB, afB) {
  ...
  if (allZero && smallDelta) {
    console.log("Cross-stream finding: the audit's monkey-patched");
    console.log("kindMult variants produce no observable change in");
    console.log("ratification count, compound generation, or named-");
    console.log("event count across BOTH stream shapes tested. Mean-");
    console.log("delta shifts are < 1% in both.");
    console.log("");
    console.log("Post-Phase-5.5 reading: production selectFromMatches");
    console.log("is set computation (no kindMult, no namingBonus, no");
    console.log("recencyExp, no effectiveWeight ranking). The audit's");
    console.log("variants install a Phase-5-era selectFromMatches");
    console.log("locally; their identical outputs confirm the audit's");
    console.log("installed layer is inert relative to the production");
    console.log("set-computation pipeline. This is the expected post-");
    console.log("Phase-5.5 state.");
    console.log("");
    console.log("The 115/115 tests passing without dependence on these");
    console.log("constants is consistent with this state: nothing in");
    console.log("the test corpus measures a property the constants");
    console.log("affect, because they no longer exist in production.");
  } else {
    console.log("Cross-stream finding: results differ across streams.");
    console.log("Variant divergence post-Phase-5.5 indicates the");
    console.log("audit's installed layer no longer matches the");
    console.log("production set-computation pipeline. Investigate");
    console.log("whether production has acquired imposed precedence");
    console.log("that would re-introduce ranking-sensitivity.");
  }
}
