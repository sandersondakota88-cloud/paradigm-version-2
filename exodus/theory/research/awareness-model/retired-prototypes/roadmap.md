...
1. Read this roadmap
1. Read the relevant spec extensions (SE-01 through SE-04)
1. Read the algorithm catalog entries marked in the “Dependencies”
   of the step
1. Before coding: answer the design decisions listed
1. Build with the discipline that held through steps 1-2:
   ASCII-only, defense stack, test headlessly before shipping
1. Ship with a short summary of what was built and what was caught
